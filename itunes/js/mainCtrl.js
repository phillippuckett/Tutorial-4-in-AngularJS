angular.module('itunes').controller('mainCtrl', function ($scope, itunesService) {
  ...
  //the 'data' property.
  //The value is 'songData'.
  //That means ng-grid is looking for songData on $scope and is putting whatever songData is into the grid.
  //this means when you make your iTunes request, 
  //you'll need to get back the information, 
...
*/
  ...
  //Create a new array and then loop through the iTunes data pushing into your new array objects that look like the above data.
